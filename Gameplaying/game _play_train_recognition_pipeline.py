...
DATA_PATH = os.path.join('Project/Gameplaying/Train_Data')
print(DATA_PATH)
...
def run_action_recognition_pipeline(DATA_PATH, actions, no_sequences, sequence_length, start_folder, boolean_function=True):
    ...
    model = create_and_train_lstm_model(X_train, y_train, actions, log_dir='Logs', epochs=100)
    ...
    model.save("Project\Gameplaying\models\\actions.h5")
